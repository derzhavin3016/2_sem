 ...
 * \return Pointer to array with strings with ending '\0', if error is detected, return nullptr.
...
{
  const unsigned char* s1 = ((const String *)str1)->str;
  const unsigned char* s2 = ((const String *)str2)->str;
